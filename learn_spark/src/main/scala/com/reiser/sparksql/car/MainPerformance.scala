...
object MainPerformance {
  def main(args: Array[String]): Unit = {
    ...
    result03.write.format("csv").save("/user/student04/xuzeze/result03")
  ...
  private def Case4(spark: SparkSession) = {
    ...
    result04.write.format("csv").save("/user/student04/xuzeze/result04")
  }

  private def Case6(spark: SparkSession) = {
